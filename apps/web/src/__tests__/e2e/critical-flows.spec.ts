...
test.describe("Critical flows", () => {
  ...
  test.describe("Checkout flow", () => {
    ...
    test("can navigate back from checkout", async ({ page }) => {
      ...
      const backButton = page.locator("button:has-text('Back'), a:has-text('Continue Shopping'), button:has-text('Continue')").first();
  ...
  test.describe("Product browsing flow", () => {
    test("explore page displays products", async ({ page }) => {
      ...
      const productGrid = page.locator("[class*='grid'], [class*='product'], [role='list']").first();
    ...
    test("product detail page displays product information", async ({ page }) => {
      ...
      const productInfo = page.locator("[class*='product'], [class*='detail'], [class*='description']").first();
