...
export function ShopManageMenu({ shop }: ShopManageMenuProps) {
  ...
  return (
    <ShowOwner ownerUserId={ownerUserId}>
      <DropdownMenu>
        <DropdownMenuTrigger data-testid="shop-manage-menu" render={<Button size="icon" variant="ghost" />}>
        ...
        <DropdownMenuContent align="end" className="w-56">
          ...
          <DropdownMenuGroup>
            <DropdownMenuItem render={<Link params={{ id }} search={{ isBundle: undefined }} to="/shops/$id/inventory" />}>
