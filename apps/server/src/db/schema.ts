...
export const availabilityRegularRelations = relations(availabilityRegular, ({ one }) => ({
  winemaker: one(winemakers, { fields: [availabilityRegular.winemakerId], references: [winemakers.id] }),
...
export const availabilityExceptionsRelations = relations(availabilityExceptions, ({ one }) => ({
  winemaker: one(winemakers, { fields: [availabilityExceptions.winemakerId], references: [winemakers.id] }),
...
export const eventInvitesRelations = relations(eventInvites, ({ one }) => ({
  ...
  winemaker: one(winemakers, { fields: [eventInvites.winemakerIdInvited], references: [winemakers.id] }),
}))
...
export const winemakerReviewsRelations = relations(winemakerReviews, ({ one }) => ({
  ...
  winemaker: one(winemakers, { fields: [winemakerReviews.winemakerId], references: [winemakers.id] }),
}))
