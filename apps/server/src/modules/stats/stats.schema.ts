...
// ── TypeBox schemas for Elysia route response typing ─────────────────────────

const statusCounts = t.Object({
  approved: t.Integer(),
  pending: t.Integer(),
  rejected: t.Integer(),
});

export const customerStatsResponse = t.Object({
  eventsAttended: t.Integer(),
  ordersCount: t.Integer(),
  reviewsWritten: t.Integer(),
  role: t.Literal("customer"),
  totalSpent: t.Number(),
});

export const winemakerStatsResponse = t.Object({
  avgReviewScore: t.Nullable(t.Number()),
  eventsByStatus: statusCounts,
  role: t.Literal("winemaker"),
  supplyAgreementsByStatus: statusCounts,
  totalStock: t.Integer(),
  wineCount: t.Integer(),
});

export const shopOwnerStatsResponse = t.Object({
  orderItemsProcessed: t.Integer(),
  productsByType: t.Object({ bundles: t.Integer(), standard: t.Integer() }),
  revenue: t.Number(),
  role: t.Literal("shop_owner"),
  shopsCount: t.Integer(),
  supplyAgreementsByStatus: statusCounts,
  totalStockValue: t.Number(),
});

export const adminStatsResponse = t.Object({
  deletedReviews: t.Integer(),
  pendingEvents: t.Integer(),
  pendingRoleRequests: t.Integer(),
  role: t.Literal("admin"),
  totalEvents: t.Integer(),
  totalProducts: t.Integer(),
  totalRevenue: t.Number(),
  totalShops: t.Integer(),
  totalWinemakers: t.Integer(),
  usersByRole: t.Object({
    admin: t.Integer(),
    customer: t.Integer(),
    shop_owner: t.Integer(),
    winemaker: t.Integer(),
  }),
});

export const statsResponseType = t.Union([
  customerStatsResponse,
  winemakerStatsResponse,
  shopOwnerStatsResponse,
  adminStatsResponse,
]);
